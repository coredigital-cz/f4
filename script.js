...
/* Urmareste automat orice click pe linkuri de telefon (tel:) si WhatsApp (wa.me) */
document.addEventListener('DOMContentLoaded', () => {
  if (typeof gtag !== 'function') return;

  const trackedLinks = document.querySelectorAll('a[href^="tel:"], a[href*="wa.me"]');
  trackedLinks.forEach(link => {
    link.addEventListener('click', () => {
      gtag('event', 'conversion', {
        'send_to': 'AW-18345405692/aYt8CO6IqNYcEPzZ4qtE'
      });
    });
  });
});
